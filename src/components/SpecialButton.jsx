const SpecialButton = ({ href, buttonText, className, padding, onClick }) => {
    return (
      ...
      >
        <span
          className={`relative z-10 block overflow-hidden font-medium leading-tight text-primary1 transition-transform duration-200 ease-linear border-[1px] border-primary1 rounded-lg group-hover:text-primary2 group-hover:translate-x-1 group-hover:translate-y-1 ${padding}`}
        >
